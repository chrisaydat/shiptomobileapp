...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const OnboardingpageoneWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/onboardingpageone',
          builder: (context, params) => const OnboardingpageoneWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/browseshipments',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'browseshipments')
              : const BrowseshipmentsWidget(),
        ),
        FFRoute(
          name: 'messages',
          path: '/messages',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/shiptosplashscreen.png',
                    fit: BoxFit.fitWidth,
                  ),
                )
